...
if __name__=='__main__':
    ...
    parser.add_argument("--num_batches", help="run NUM_BATCHES chunks of tests one-by-one",type=int, default=3)
    parser.add_argument("--start_batch_num", type=int, default=1)
    parser.add_argument("--end_batch_num", type=int, default=3)
