...
if __name__=="__main__":
    ...
    if vals.plot:
        ...
        plot_kalman(data_file, calib_fname, freq, use_spline=True, customized_shift=None, plot_commands='s12fh')
        ...
        rviz_kalman('', bag_file, data_file, calib_fname, freq, use_rgbd=False, use_smoother=False, use_spline=False, customized_shift=None, single_camera=False)
